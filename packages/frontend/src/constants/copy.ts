export const COPY = {
  ...
  checkout: {
    ...
    totalLabel: (total: number) => `Total – ₪${total.toFixed(2)}`,
    completePaymentLabel: 'Complete payment',
    completePaymentAlt: 'Complete payment',
    genericError: 'Something went wrong placing your order. Please try again.',
    invalidPhoneError: 'Please enter a valid phone number.',
    invalidCardNumberError: 'Please enter a valid card number (13–19 digits).',
